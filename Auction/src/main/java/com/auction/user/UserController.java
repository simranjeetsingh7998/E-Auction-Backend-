...
public class UserController {
	...
	public ResponseEntity<ApiResponse> createUser(@Valid @RequestBody UserVO userVO) {
		return new ResponseEntity<>(new ApiResponse(HttpStatus.OK.value(), "User created Successfully",
	...
	public ResponseEntity<ApiResponse> getUsers() {
		return new ResponseEntity<>(new ApiResponse(HttpStatus.OK.value(), "User fetched Successfully",
